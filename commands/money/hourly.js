...
module.exports = class {
    ...
    async onChat(msg, args, config) {
        ...
        if(cooldown.length == 0) {
            ...
            //Calculate the differences between the time and check if it 's been an hour
            ...
            if( hours >= 1) {
                //It's been longer than an hour so we can give them money
                ...
                var cooldown    = `${59-displayMinutes}m ${59-displaySeconds}s`;
...
module.exports.config = {
    ...
    payout: {
        amount: '300',
        approved: '``ᕮ300`` was added to your wallet. Your new balance is ``ᕮ%balance%``.',
