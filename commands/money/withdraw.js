...
module.exports = class {
    ...
    async onChat(msg, args, config) {
        ...
        msg.channel.send({ embed: {
            ...
            description: `<@${msg.author.id}> withdrew ᕮ${amount.toLocaleString(undefined, { minimumFractionDigits: 2 })}. There is ᕮ${wallet.toLocaleString(undefined, { minimumFractionDigits: 2 })} in your wallet and ᕮ${bank.toLocaleString(undefined, { minimumFractionDigits: 2 })} in your bank`
        }});
