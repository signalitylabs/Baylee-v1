...
module.exports = class {
    ...
    async onChat(msg, args, config) {
        ...
        if(cooldown.length == 0) {
            ...
            //I never remember how time is saved so I'm sure I messed this up
            //Maybe I'll come back when I understand it better
            ...
            if( days >= 30) {
                ...
                var cooldown    = `${29-days}d ${23-displayHours}h ${59-displayMinutes}m ${59-displaySeconds}s`;
...
module.exports.config = {
    ...
    channel_bind: '688072705865810008',

    payout: {
        amount: '6500',
        approved: '``ᕮ6,500`` was added to your wallet. Your new balance is ``ᕮ%balance%``.',
