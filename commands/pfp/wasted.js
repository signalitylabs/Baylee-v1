...
module.exports = class {
    ...
    async onChat(msg, args, config) {
        ...
        var overlay = await Jimp.read('./assets/images/avatar/wasted.png')
        .then(async image => { return await image.resize(Jimp.AUTO, 600);  });

        var mentioned   = await Jimp.read('./assets/images/avatar/wasted.png')
        .then(async image => {
        ...
        const attachment = new Discord.MessageAttachment(x, 'wasted.png');
