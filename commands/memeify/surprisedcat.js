...
module.exports.config = {
    ...
    error: {
        empty: 'You need to enter (2) values separated by a comma. For example `dank memes on reddit, dank memes on discord`'
    }
}