...
module.exports.config = {
    info: {
        module: 'memeify',
        name: '🔪 Oh boy, here I go',
        trigger: 'killingagain',
        aliases: [],
        tags: ['rick', 'morty', 'rick and morty', 'rick & morty'],
        usage: '%trigger% <text>',
        required: 1,
        color: 13244606
    },
